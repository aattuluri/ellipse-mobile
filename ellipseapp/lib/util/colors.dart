...
//const lightBackgroundColor = Color(0xFFF0F0F0);
//const lightCardColor = Color(0xFFDEDEDE);
const lightBackgroundColor = Color(0xFFDEDEDE);
const lightCardColor = Color(0xFFCFD3D6);
...
const blackCardColor = Color(0xFF111111);
