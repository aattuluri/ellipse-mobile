...
class _TransitionSnapshotFabLocation extends FloatingActionButtonLocation {
  ...
  @override
  Offset getOffset(var scaffoldGeometry) {
...
class _FloatingActionButtonTransitionState
  ...
  void didUpdateWidget(_FloatingActionButtonTransition oldWidget) {
    ...
    if (oldWidget.fabMotionAnimator != widget.fabMotionAnimator ||
        oldWidget.fabMoveAnimation != oldWidget.fabMoveAnimation) {
...
class AppScaffold extends StatefulWidget {
  ...
  static AppScaffoldState of(BuildContext context, {bool nullOk = false}) {
    ...
    final AppScaffoldState result =
        context.ancestorStateOfType(const TypeMatcher<AppScaffoldState>());
  ...
  static bool hasDrawer(BuildContext context,
    ...
    if (registerForUpdates) {
      ...
      final AppScaffoldState scaffold =
          context.ancestorStateOfType(const TypeMatcher<AppScaffoldState>());
      return scaffold?.hasDrawer ?? false;
    }
  }
...
class AppScaffoldState extends State<AppScaffold>
    with TickerProviderStateMixin {
  // DRAWER API
  final GlobalKey<AppDrawerControllerState> _drawerKey =
      GlobalKey<AppDrawerControllerState>();
  final GlobalKey<AppDrawerControllerState> _endDrawerKey =
      GlobalKey<AppDrawerControllerState>();
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsets minInsets = mediaQuery.padding.copyWith(
      bottom: widget.resizeToAvoidBottomPadding
